...
document.writeln("");
document.writeln("                <div class=\"pswp__counter\"><\/div><a href=\"javascript:void(0)\" class=\"btn_remove pswp__button pswp__button--close\"  title=\"Close (Esc)\">删除<\/a>");
document.writeln("");
        ...
        var initPhotoSwipeFromDOM = function(gallerySelector) {
            ...
            var parseThumbnailElements = function(el) {
                ...
                for(var i = 0; i < numNodes; i++) {
                    ...
                    console.log(el.getAttribute('data-size').split('x'));
