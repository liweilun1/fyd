(function (window) {
  ...
  function getRandomImg() {
    return pathUrl + '/images/img/' + getRandomNumberByRange(0, 20)+'.jpg'
  ...
  class jigsaw {
    ...
    bindEvents() {
      ...
      document.addEventListener('mousemove', (e) => {
          if(this.sliderContainer.className.indexOf('sliderContainer_success') !== -1) return false
  ...
  window.jigsaw = {
    init: function (element, path, success, fail) {
      pathUrl = path;
